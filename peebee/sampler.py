...
def sample_alos_sources_RPL(model, n, com, rscale, gamma, low_lim=0.01, up_lim=5):
	...
	urv_pow = ((up_lim**(gamma + 1) - low_lim**(gamma + 1))*y + low_lim**(gamma + 1))**(1/(gamma+1))
